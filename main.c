...
/* @note Due to the way the module flash increment is constructed seperate callbacks for writing to events and
 * header pages are necessary. This will change.*/
/* @note Total number of pages - that is for data and header must be passed to init funciton. This will
 * change. */
