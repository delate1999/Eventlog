...
/* Try to derive from arch/compiler-specific macros */
#elif defined(_X86_) || defined(__x86_64__) || defined(__i386__) || defined(__i486__) ||                     \
	defined(__i586__) || defined(__i686__) || defined(__MIPSEL) || defined(_MIPSEL) || defined(MIPSEL) ||    \
	defined(__ARMEL__) || defined(__MSP430__) || (defined(__LITTLE_ENDIAN__) && __LITTLE_ENDIAN__ == 1) ||   \
	(defined(_LITTLE_ENDIAN) && _LITTLE_ENDIAN == 1) || defined(_M_ARM) || defined(_M_ARM64) ||              \
	...
	#define ENDIANNESS_LE 1
	#define ENDIANNESS_BE 0
#elif defined(__MIPSEB) || defined(_MIPSEB) || defined(MIPSEB) || defined(__MICROBLAZEEB__) ||               \
	defined(__ARMEB__) || (defined(__BIG_ENDIAN__) && __BIG_ENDIAN__ == 1) ||                                \
